...
from services.ethics.semantic_boundary_detector import (  # noqa: E402
    ...
    SEMANTIC_DETECTOR_PROMPT_V0_2,
    SemanticBoundaryDetector,
)

# Active prompt version for this run. Bump as calibration rounds advance.
ACTIVE_PROMPT = SEMANTIC_DETECTOR_PROMPT_V0_2
ACTIVE_PROMPT_VERSION = "SEMANTIC_DETECTOR_PROMPT_V0_2"
...
async def main_async(output_path: Optional[Path] = None) -> Path:
    print(
        f"[run_probe_set_v0_1] Initializing live SemanticBoundaryDetector "
        f"(prompt={ACTIVE_PROMPT_VERSION})..."
    )
    detector = SemanticBoundaryDetector(prompt=ACTIVE_PROMPT)
