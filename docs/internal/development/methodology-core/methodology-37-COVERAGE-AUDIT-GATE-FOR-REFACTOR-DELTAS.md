...
- **Pattern-073 Documentation-Asserted-Behavior Drift** (recognition discipline; catches what prevention misses): `docs/internal/architecture/patterns/pattern-073-documentation-asserted-behavior-drift.md`
