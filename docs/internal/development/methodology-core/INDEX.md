...
- [53-CHOKEPOINT-VS-BOLT-ON.md](methodology-53-CHOKEPOINT-VS-BOLT-ON.md) - Chokepoint vs. Bolt-On — a recurring obligation survives only if attached to something that already can't be skipped without visibly breaking a procedure in progress; the test is whether skipping it produces a visible break. Filed 2026-09-08 (CIO) — proven-by-use across 4+ shipped mechanisms this week, filed late after HOST found it had never been a citable document.
