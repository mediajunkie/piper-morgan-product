...
- **Response-text surfaces** (chat replies, declines, error/degraded paths) → **Colleague Test rubric** (R/C/T, ≥7/9, no zero-dimension, auto-fail rules per path type). `docs/internal/testing/colleague-test-rubric.md` (canonical version **v2.3.4**; its three invariants are PM-ratified as of 2026-08-31 — see that file's Tier status).
