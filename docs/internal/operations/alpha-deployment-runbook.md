...
**Status**: ⚠️ **SUPERSEDED 2026-09-22 — alpha is served by Fly now** (cutover complete; see `alpha-fly-cutover-runbook-2026-09-22.md` and the deploy-environments doc's 09-22 banner). This doc remains the droplet's ops record only until decommission (~09-29), then it is historical. *(Prior status: COMPLETE — mechanism reverse-engineered from the live droplet by Lead Dev, 2026-06-19; was a STUB, PA flagged the gap.)*
