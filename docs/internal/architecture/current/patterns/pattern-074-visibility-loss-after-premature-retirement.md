...
- Pattern-074's annotation-in-active-queue discipline assumes a hand-writable annotation surface exists alongside the inbox folder
- methodology-36's derived-views-over-hand-maintained-trackers principle, applied to MANIFEST, makes MANIFEST derived from inbox state — which clobbers any hand-annotation
