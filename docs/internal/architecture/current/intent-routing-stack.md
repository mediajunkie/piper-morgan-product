...
#1190-gated (see surface 3). Still on the chain and outside the gate: create_todo /
complete_todo / list_todos / next_todo (and create_reminder's backstop elif — its
rail entry is the consented surface); `capability_legibility.catalog_coverage()`
