...
- **Pattern-069 (Coarse Triggers Causing False-Positive Triage Cost)** **Proven** (promoted 2026-08-25) — filed Emerging 2026-05-11 (CIO; hook-design meta-pattern from PreCompact-hook two-incident thread); promoted on cross-mechanism recurrence evidence from the freeze-watchdog's self-resolving-alert pattern (5 alerts, 4-of-6 days, 100% self-resolved before triage, escalated 2026-08-17) — found three months after the original two-week promotion window lapsed unchecked, during an unrelated tracker audit.
...
- [Pattern-069: Coarse Triggers Causing False-Positive Triage Cost](pattern-069-coarse-triggers-false-positive-triage-cost.md) - Hook/trigger granularity too coarse generates false-positive triage load (**Proven**)
