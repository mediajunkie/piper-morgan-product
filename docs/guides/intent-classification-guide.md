...
**See also**: [Architecture Decision Record (ADR) 060: Floor-First Routing](https://github.com/mediajunkie/piper-morgan-product/blob/main/docs/internal/architecture/adrs/adr-060-floor-first-routing.md), [Canonical Handlers Architecture](canonical-handlers-architecture.md)
...
See [ADR-060](https://github.com/mediajunkie/piper-morgan-product/blob/main/docs/internal/architecture/adrs/adr-060-floor-first-routing.md)
...
- [ADR-060: Floor-First Routing](https://github.com/mediajunkie/piper-morgan-product/blob/main/docs/internal/architecture/adrs/adr-060-floor-first-routing.md) —
