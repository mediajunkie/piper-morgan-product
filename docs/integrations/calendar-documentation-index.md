...
### Integration Guide
**File**: [`docs/integrations/calendar-integration-guide.md`](calendar-integration-guide.md)
...
**File**: [`docs/internal/architecture/adrs/adr-038-spatial-intelligence-patterns.md`](https://github.com/mediajunkie/piper-morgan-product/blob/main/docs/internal/architecture/adrs/adr-038-spatial-intelligence-patterns.md)
...
2. Read [Integration Guide](calendar-integration-guide.md)
