...
**Version**: 2.6
**For**: Piper Morgan 0.8.9.1 Alpha Release
...
Once set up, your API keys are stored in your macOS keychain via Settings → Integrations (BYOC credential layer). In 0.8.9.1, they're also encrypted at rest and routed per-request — no more re-entering keys after restarts, and your key is yours end-to-end.
...
This is ALPHA software (version 0.8.9.1). That means:
...
- [ ] Verify all technical claims are current for version 0.8.9.1
...
- Version 0.8.9.1 (not "alpha" or "latest")
...
_For Software Version: 0.8.9.1_
