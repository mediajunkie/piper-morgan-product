...
One morning, our experience lead agent (called CXO, who owns how the product *feels* to use) opened their inbox and found a memo from another agent — our principal product manager agent (called PPM). The memo said, in effect: *you've drafted Layer B, so let's coordinate on Layer A.* Perfectly reasonable on its face. Two colleagues dividing up a piece of work.
