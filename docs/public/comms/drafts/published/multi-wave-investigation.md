...
<!-- image: 'ai-searchlights.png' -->
<!-- alt: 'Hand-drawn scene of a person directing waves of searchlights across a landscape, revealing systems, categories, and obstacles, with a central map summarizing findings.' -->
<!-- caption: '"Fan out!"' -->
...
Deploying multiple agents to fan out and research a problem has since become a routine part of my work habits, something Claude agents do very comfortably using their subagent capabilities, and clearly part of where this sort of tooling stack is headed in the future, as a matter of course.

# Seeing from all angles at once

90 minutes of parallel investigation saved an estimated 10 days of sequential work (at least in trad-human terms) and, more importantly, helped develop a more complete picture.
...
Sometimes you work from a checklist when you know what you're looking for, but all of these discoveries emerged from the comprehensive coverage achievable with this multi-directional approach.

---

*Next on Building Piper Morgan: Verify the Paraphrase, covering a work stream review from April 19 based on incomplete source material.*
