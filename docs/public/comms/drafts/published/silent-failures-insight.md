...
<!-- image: 'ai-departures.png' -->
<!-- alt: 'Airport departures board shows all flights on time, while outside planes are visibly broken and patched up.' -->
...
*Next on Building Piper Morgan: The Mismatch Date, in which two lines of code, both correct, both passing review, creating a bug that hid for months.*
