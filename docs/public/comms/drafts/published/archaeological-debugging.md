...
<!-- image: 'ai-scarab.png' -->
<!-- alt: 'Developer and AI agents excavate a giant scarab labeled with existing features, uncovering fully built code buried under layers of old issues and TODOs.' -->
<!-- caption: '"The legends were true!"' -->


*December 22, 2025*

It was 8:06 AM on a Monday in December. I asked the Lead Developer to implement Query #2 in our list of canonical queries (dynamic capabilities, the ability for users to ask "what can you do?").
...
Thus December 22nd became an archaeology day. We had set out to implement 20 canonical queries. What we found instead was that many were already built:
...
Sounds like people problems, right? Yes, they learned it from us.

# The ongoing cost

That day, we had to spend time investigating how to implement features that already existed. We wrote gameplans for code that was already written. We deployed agents to build things that were already built.
...
This sounds bureaucratic. It's actually faster. The investigation phase that day took 15 minutes per query. Implementation for queries that actually needed building took 30-60 minutes. Finding existing code saved 15-45 minutes per discovery.


# The broader lesson

Since that day we have implemented auditing more broadly into most of our processes. This isn't unique to AI-assisted development, but AI easily makes it worse. When you can build things quickly, you build more things. When you build more things, you forget more things.
...
# This one's meta-pattern

I'm noticing something about how projects evolve. We think of software development as linear: plan, build, ship. But real projects are archaeological sites. They have layers. Things get built and buried. Features exist in strata, some documented, some not.
...
*Next on Building Piper Morgan, we resume the building narrative on March 22 with "The Closing Sprint."*

*What sort of methods have you uncovered to prevent your AI agents from reinventing the wheel, and to make their archaeological investigations more efficient? I'm still learning!*
