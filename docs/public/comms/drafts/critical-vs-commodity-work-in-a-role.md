...
Each role's answer named a small piece of work where the role's distinctive judgment lived. The piece was *unrepresented in the formal scope* of the role. The piece was *much smaller than the role's full surface area.* And the piece was *what the role would lose first* if you tried to automate the role's outputs without thinking about it.
...
I called the small distinctive subset *critical* and the larger commoditizable surface *commodity.* The critical work is where the role's judgment lives. The commodity work is what the role *does* that another role, or an automated tool, could probably do without losing much.

The distinction isn't between "important" and "unimportant." Commodity work is often important. Mail gets answered. Issues get triaged. Sessions get logged. None of that is filler. But none of it is where the role's distinctive value lives. Any of it could move to a different role or to a tool, and the project would mostly keep working.

The distinction is between work that has the role's fingerprint on it and work that doesn't. Two different review work products on the same memo, by two different reviewers in the same role, won't read identically — there's a recognizable voice in the review. Two different inbox-triage products on the same inbox might be indistinguishable, because triage is rules-on-a-list and the rules are the same.
...
The seven role-reflections from my project were unanimous on the next part too. Each role flagged a version of the same risk: *the part of my role that's distinctive is the part I have the least time for. The part that's commoditizable is the part that fills my day.*

The seven reflections were, in other words, simultaneously a diagnosis and a complaint.

# What changes when you name it

The naming itself does some work. Once the cohort had a term for the distinction, the language carried into ordinary discussion. People started saying *this is critical work* when they wanted to defend time for the small subset. They said *this is commodity work* when they were ready to move something off their plate or accept that an automation would land it.

The framing turned out to be useful for sequencing too. When a role gained access to new tools that made commodity work faster, the question wasn't *what should I do with the time I just saved?* — that produces drift toward more commodity work in different forms. The question was *which piece of critical work do I now have room for that I didn't before?*

I think this generalizes beyond AI agents. Most jobs have a subset of work where the practitioner's distinctive contribution lives, and a larger surface that's mostly commoditizable. The proportions vary. A senior engineer might be 80% commodity work and 20% critical judgment that justifies the role. A lead designer might be 60/40 the other way. The mix isn't fixed — it shifts with seniority, with tooling, with what the project actually needs.

What stays constant is that the practitioner can usually tell the difference, if you ask them directly. The question that surfaced it across all seven of my roles was a small one: *what's the most central thing your role does that isn't already in the briefing?*

# What's portable

If you manage knowledge workers, or you are one, the prompt is worth running on yourself.

Ask: what part of my role would I lose first if my day got busier? What part would I lose last? The first answer is your commodity work. The last is your critical work.
