...
Thursday night. Ten-thirty. Fresh alpha account on a clean machine. The CXO had a scoring rubric ready — the Colleague Test, three dimensions, zero through three on each, seven to pass, any zero auto-fails. Nine queries lined up. Five task lifecycle scenarios. We'd been preparing for this for weeks.

The first query was "What can you help me with?"

[ADD PERSONAL DETAIL — what it felt like to finally sit down for this test after weeks of preparation]
...
[CONSIDER — was there a moment of recognition or resignation here?]
...
[ADD PERSONAL DETAIL — how did this feel? The second zero was worse than the first because you thought you'd fixed it]
...
*Next on Building Piper Morgan: The Deeper Why — when the fix doesn't change the symptom, the diagnosis was wrong.*
