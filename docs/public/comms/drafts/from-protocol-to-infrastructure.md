...
*February 25 – May 12, 2026*

Ever since I gave my agents mailboxes, I've had to remind them manually to check their inboxes for new memos from other agents. I try to remember to nudge them at session start and whenever I notice that they have new mail, including after compaction.
...
It's not about discipline or caring. My Lead Developer agent cared deeply about checking the mailbox. After a long implementation session, context compacts, and the agent is picking up where it left off with fresh context — the mailbox check often just doesn't happen. The rule exists. The intention exists. The behavior doesn't.
