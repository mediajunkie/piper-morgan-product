...
**An external-facing language frame for BYOC** was contributed by Communications and folded into PDR-005 as a dedicated section. It was the last load-bearing input on the path to ratification-ready.
