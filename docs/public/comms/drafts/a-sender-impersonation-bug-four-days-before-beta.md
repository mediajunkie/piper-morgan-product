...
Four days before a launch is an anxious time to find privacy bugs! Fortunately, we got it fixed without assuming the first patch was the end of the question.

---

*Next on Building Piper Morgan: "Repetition Isn't Convergence" — four agents independently measure the wrong thing and agree with each other, and the agreement gets mistaken for proof.*
