...
- `piper-morgan-product/docs/internal/architecture/patterns/pattern-073-documentation-asserted-behavior-drift.md` — partial read (instance count + CIO resolution-shape note); 11 instances / 9 layers
