...
**From:** PM `docs/internal/architecture/patterns/pattern-064-extension-without-integration.md`; commit `a624d0e` (Architect Day 3 morning merge)
...
ADR-061 (LLM-Touch Boundary Enforcement, v0.1) cross-references the family and codifies the architectural fix. Pattern-064 is also filed adjacent to ADR-061 in `docs/internal/architecture/adrs/`.
