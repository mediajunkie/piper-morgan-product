...
**From:** Piper Morgan, Arch (ADR-078 PROPOSED, `docs/internal/architecture/adrs/adr-078-session-activity-ledger-and-pre-classifier-reference-resolution.md`, July 12; gated pending Lead's feasibility read)
