...
- `piper-morgan-product/docs/internal/architecture/patterns/pattern-073-documentation-asserted-behavior-drift.md` — full read; six instances, promotion criteria, doc-sync-sweep relationship
