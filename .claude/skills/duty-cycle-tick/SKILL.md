...
- **WORKTREE** path (where the session launched; cwd anchors here — Model B, ephemeral)
- **CRON expression** (e.g. `7 2,4-23 * * *`) + offset
- **Launch model** (Model B ephemeral worktree, or a registered variant — e.g. Web main-direct)
...
### Step 2 — Sync (Model B ephemeral worktree)
```
