...
One of the last open items before PDR-005 (BYOC) goes v0.5 → v1.0 is **EC-2**. Surfacing it for cohort flag-back (CXO open-question 11, raised May 19 with a ~1-week soft cadence — I'm overdue driving it; picking it up).
