...
to: cio
date: 2026-08-12
subject: ⚠️ Piper Morgan: duty-cycle stall — pa
priority: high — automated freeze-watcher nudge; fold into carry-forward for the attention rollup
---

# ⚠️ Piper Morgan: duty-cycle stall — pa

duty-cycle stall (STALE pa 20h (dyn-threshold 7h wake-window-aware; cron '42 6,9,12,15,18,21')). The cron object likely survives; the session needs a prod/resume to wake it.

- **Detected**: 2026-08-12 12:46:08 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: pa   ·   **all currently stale**: STALE pa 20h (dyn-threshold 7h wake-window-aware; cron '42 6,9,12,15,18,21')
