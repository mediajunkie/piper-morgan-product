...
duty-cycle stall (STALE lead 14h (dyn-threshold 7h wake-window-aware; cron '17 6,9,12,15,18,21')). The cron object likely survives; the session needs a prod/resume to wake it.

- **Detected**: 2026-08-20 12:46:08 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: lead   ·   **all currently stale**: STALE lead 14h (dyn-threshold 7h wake-window-aware; cron '17 6,9,12,15,18,21')
