...
3 duty-cycle roles silent at once (STALE arch 8h (dyn-threshold 7h wake-window-aware; cron '27 6,9,12,15,18,21');STALE lead 8h (dyn-threshold 7h wake-window-aware; cron '17 6,9,12,15,18,21');STALE web 8h (dyn-threshold 7h wake-window-aware; cron '22 6,9,12,15,18,21')) — likely machine-asleep/backgrounded (cron-survives-doesn't-fire), not individual failures. One wake of the machine/app likely covers it.

- **Detected**: 2026-08-04 06:46:06 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: arch lead web   ·   **all currently stale**: STALE arch 8h (dyn-threshold 7h wake-window-aware; cron '27 6,9,12,15,18,21');STALE lead 8h (dyn-threshold 7h wake-window-aware; cron '17 6,9,12,15,18,21');STALE web 8h (dyn-threshold 7h wake-window-aware; cron '22 6,9,12,15,18,21')
