...
to: cio
date: 2026-08-06
subject: ⚠️ Piper Morgan: duty-cycle stall — cxo docs
priority: high — automated freeze-watcher nudge; fold into carry-forward for the attention rollup
---

# ⚠️ Piper Morgan: duty-cycle stall — cxo docs

duty-cycle stall (STALE cxo 8h (dyn-threshold 7h wake-window-aware; cron '47 6,9,12,15,18,21');STALE docs 8h (dyn-threshold 7h wake-window-aware; cron '57 6,9,12,15,18,21')). The cron object likely survives; the session needs a prod/resume to wake it.

- **Detected**: 2026-08-06 18:46:06 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: cxo docs   ·   **all currently stale**: STALE cxo 8h (dyn-threshold 7h wake-window-aware; cron '47 6,9,12,15,18,21');STALE docs 8h (dyn-threshold 7h wake-window-aware; cron '57 6,9,12,15,18,21')
