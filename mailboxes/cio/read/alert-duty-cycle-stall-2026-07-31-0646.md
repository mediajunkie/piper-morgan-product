...
to: cio
date: 2026-07-31
subject: ⚠️ Piper Morgan: duty-cycle stall — web
priority: high — automated freeze-watcher nudge; fold into carry-forward for the attention rollup
---

# ⚠️ Piper Morgan: duty-cycle stall — web

duty-cycle stall (STALE web 8h (dyn-threshold 7h wake-window-aware; cron '22 6,9,12,15,18,21')). The cron object likely survives; the session needs a prod/resume to wake it.

- **Detected**: 2026-07-31 06:46:06 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: web   ·   **all currently stale**: STALE web 8h (dyn-threshold 7h wake-window-aware; cron '22 6,9,12,15,18,21')
