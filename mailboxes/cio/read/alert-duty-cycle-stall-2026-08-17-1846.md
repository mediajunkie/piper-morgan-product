...
to: cio
date: 2026-08-17
subject: ⚠️ Piper Morgan: duty-cycle stall — docs
priority: high — automated freeze-watcher nudge; fold into carry-forward for the attention rollup
---

# ⚠️ Piper Morgan: duty-cycle stall — docs

duty-cycle stall (STALE docs 7h (dyn-threshold 7h wake-window-aware; cron '57 6,9,12,15,18,21')). The cron object likely survives; the session needs a prod/resume to wake it.

- **Detected**: 2026-08-17 18:46:09 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: docs   ·   **all currently stale**: STALE docs 7h (dyn-threshold 7h wake-window-aware; cron '57 6,9,12,15,18,21')
