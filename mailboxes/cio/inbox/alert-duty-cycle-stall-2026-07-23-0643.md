...
duty-cycle stall (STALE arch 89h (dyn-threshold 5h wake-window-aware; cron '27 6,9,12,15,18,21');STALE lead 8h (dyn-threshold 5h wake-window-aware; cron '17 6,9,12,15,18,21')). The cron object likely survives; the session needs a prod/resume to wake it.

- **Detected**: 2026-07-23 06:43:02 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: arch lead   ·   **all currently stale**: STALE arch 89h (dyn-threshold 5h wake-window-aware; cron '27 6,9,12,15,18,21');STALE lead 8h (dyn-threshold 5h wake-window-aware; cron '17 6,9,12,15,18,21')
