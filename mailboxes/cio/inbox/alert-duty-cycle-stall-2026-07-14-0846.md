...
duty-cycle stall (STALE exec 23h (dyn-threshold 19h wake-window-aware; cron '32 8,20');STALE lead 38h (dyn-threshold 5h wake-window-aware; cron '17 6,9,12,15,18,21')). The cron object likely survives; the session needs a prod/resume to wake it.

- **Detected**: 2026-07-14 08:46:02 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: exec   ·   **all currently stale**: STALE exec 23h (dyn-threshold 19h wake-window-aware; cron '32 8,20');STALE lead 38h (dyn-threshold 5h wake-window-aware; cron '17 6,9,12,15,18,21')
