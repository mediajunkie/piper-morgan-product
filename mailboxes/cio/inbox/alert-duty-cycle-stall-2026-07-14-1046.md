...
3 duty-cycle roles silent at once (STALE cio 18h (dyn-threshold 10h wake-window-aware; cron '7 10,16,22');STALE exec 25h (dyn-threshold 19h wake-window-aware; cron '32 8,20');STALE lead 40h (dyn-threshold 5h wake-window-aware; cron '17 6,9,12,15,18,21')) — likely machine-asleep/backgrounded (cron-survives-doesn't-fire), not individual failures. One wake of the machine/app likely covers it.

- **Detected**: 2026-07-14 10:46:15 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: cio   ·   **all currently stale**: STALE cio 18h (dyn-threshold 10h wake-window-aware; cron '7 10,16,22');STALE exec 25h (dyn-threshold 19h wake-window-aware; cron '32 8,20');STALE lead 40h (dyn-threshold 5h wake-window-aware; cron '17 6,9,12,15,18,21')
