...
duty-cycle stall (STALE cio 103h (dyn-threshold 10h wake-window-aware; cron '7 10,16,22');STALE arch 99h (dyn-threshold 5h wake-window-aware; cron '27 6,9,12,15,18,21')). The cron object likely survives; the session needs a prod/resume to wake it.

- **Detected**: 2026-07-23 16:44:14 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: cio   ·   **all currently stale**: STALE cio 103h (dyn-threshold 10h wake-window-aware; cron '7 10,16,22');STALE arch 99h (dyn-threshold 5h wake-window-aware; cron '27 6,9,12,15,18,21')
