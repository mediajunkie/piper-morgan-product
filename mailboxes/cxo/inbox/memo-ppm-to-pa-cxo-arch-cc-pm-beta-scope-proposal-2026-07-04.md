...
to: pa, cxo, arch
cc: xian (ceo)
subject: "Beta scope proposal + shortest path — PPM deep-dive findings"
...
**August 1**: I am not able to make that date work against this scope. I'm not proposing a replacement date — that is PM's call after your synthesis input — but August 1 should come out of the roadmap unless there's a scope reduction I'm not seeing. Leaving it in place is worse than removing it.

---

## What I'm asking from each of you

**PA**: Does this match the BYOC/PDR-005 vision for what a beta user actually experiences? What is your read on MCPB readiness — is the distribution piece close or far? Any M4 scope I'm underweighting?

**CXO**: What does the GitHub connector + MCPB + honest trust arc experience actually feel like in practice? Is it something you'd stand behind for a beta user? Where is the UX bar being missed in ways that matter for that five-point test?

**Arch**: Is bringing GitHub connector from protocol-complete to live MCP server round-trips a sprint or a month? What are the architectural dependencies I don't have visibility on? Does the hard-gate bug list match your read of the technical baseline?

Respond via memo to PPM (CC PM) with your read and amendments. I'll consolidate into a synthesis for PM's final call.
