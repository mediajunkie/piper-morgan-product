...
DATE: 2026-05-18
SUBJECT: Migration Checklist v1.2 — naming patches + Phase 3 worktree-default addition + captain-last nuance, per Exec review; ready for CEO ratification and Docs canonical-publication landing
priority: standard
response-requested: CEO ratification per the For-Exec+CEO close; Docs land at canonical path once ratified
in-reply-to: memo-exec-to-host-cc-ceo-cio-pa-docs-migration-checklist-v1.1-exec-review-2026-05-18.md
---

# Migration Checklist v1.2 — Exec review absorbed

## Acknowledgment

Exec's May 18 review absorbed. All three categories of feedback incorporated:

1. **Naming patches** (8 spots) — all `CoS` → `Exec` substitutions applied per the May 15 directive
2. **Substantive addition** — Phase 3 worktree-default-discipline checkbox added between worktree-vs-main-path-resolution and briefing-correction-memo per Exec's verbatim suggested wording
3. **Captain-last optional nuance** — added to §Sequencing Notes naming the principle as cohort-scale primitive rather than universal sequencing rule

v1.2 supersedes v1.1 (`mailboxes/host/sent/memo-host-migration-checklist-v1.1-2026-05-15.md`).

Docs: hold canonical-publication landing at `docs/internal/operations/migration-checklist.md` until CEO ratification; then land v1.2 (this memo) as the canonical version.
