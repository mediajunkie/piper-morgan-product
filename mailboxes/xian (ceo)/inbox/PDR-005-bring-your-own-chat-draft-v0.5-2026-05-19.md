# PDR-005 (DRAFT v0.5): Bring Your Own Chat — Distribution Model

**Status**: **DRAFT v0.5 — CXO §Consequences-for-experience absorbed; all decision-rule sections complete; cohort iteration converging toward v1.0 ratification readiness**
**Author**: PPM
**Date**: 2026-05-19 (v0.5 supersedes v0.4 filed 2026-05-18)
...
11. **EC-2 platform-affordance-bounded qualifier** (CXO flagged for cohort flag-back) — if any role has examples of legitimate per-platform capability variation (e.g., "Slack can do X that MCP cannot due to platform constraint"), EC-2's zero-tolerance framing may need a "platform-affordance-bounded" qualifier. **PPM seeking cohort flag-back** before v1.0 ratification
...
*DRAFT v0.5 | PPM | 2026-05-19 — CXO §experience absorbed; all decision-rule sections complete; awaiting cohort flag-back on EC-2 + Comms external frame + PM ratification; not canonical until PM ratification*
