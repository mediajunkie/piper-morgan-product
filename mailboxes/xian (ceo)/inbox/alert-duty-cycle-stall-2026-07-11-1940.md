...
4 duty-cycle roles silent at once (STALE cio 24h (dyn-threshold 10h wake-window-aware; cron '7 10,16,22');STALE exec 26h (dyn-threshold 19h wake-window-aware; cron '32 8,20');STALE arch 24h (dyn-threshold 5h wake-window-aware; cron '27 6,9,12,15,18,21');STALE lead 25h (dyn-threshold 5h wake-window-aware; cron '17 6,9,12,15,18,21')) — likely machine-asleep/backgrounded (cron-survives-doesn't-fire), not individual failures. One wake of the machine/app likely covers it.

- **Detected**: 2026-07-11 19:40:44 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: arch lead   ·   **all currently stale**: STALE cio 24h (dyn-threshold 10h wake-window-aware; cron '7 10,16,22');STALE exec 26h (dyn-threshold 19h wake-window-aware; cron '32 8,20');STALE arch 24h (dyn-threshold 5h wake-window-aware; cron '27 6,9,12,15,18,21');STALE lead 25h (dyn-threshold 5h wake-window-aware; cron '17 6,9,12,15,18,21')
