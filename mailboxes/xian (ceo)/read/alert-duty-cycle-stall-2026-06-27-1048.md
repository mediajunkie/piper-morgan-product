...
duty-cycle stall (STALE cio 13h (dyn-threshold 5h wake-window-aware; cron '7 3,10,13,16,19,22')). The cron object likely survives; the session needs a prod/resume to wake it.

- **Detected**: 2026-06-27 10:48:09 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: cio   ·   **all currently stale**: STALE cio 13h (dyn-threshold 5h wake-window-aware; cron '7 3,10,13,16,19,22')
