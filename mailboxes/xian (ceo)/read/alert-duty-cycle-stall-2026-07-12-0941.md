...
3 duty-cycle roles silent at once (STALE exec 40h (dyn-threshold 19h wake-window-aware; cron '32 8,20');STALE arch 38h (dyn-threshold 5h wake-window-aware; cron '27 6,9,12,15,18,21');STALE lead 39h (dyn-threshold 5h wake-window-aware; cron '17 6,9,12,15,18,21')) — likely machine-asleep/backgrounded (cron-survives-doesn't-fire), not individual failures. One wake of the machine/app likely covers it.

- **Detected**: 2026-07-12 09:41:47 (freeze-watcher hourly run); thresholds per `dev/active/duty-cycle-registry.tsv`.
- **Newly nudge-worthy**: exec   ·   **all currently stale**: STALE exec 40h (dyn-threshold 19h wake-window-aware; cron '32 8,20');STALE arch 38h (dyn-threshold 5h wake-window-aware; cron '27 6,9,12,15,18,21');STALE lead 39h (dyn-threshold 5h wake-window-aware; cron '17 6,9,12,15,18,21')
