...
**Quality pass rate (judged queries)**: 40/60 (66.7%)
...
- **Q25** (Predictive): `What's the next milestone?` — auto-fail (dimension scored 0)
...
*Generated 2026-05-08 17:20 by canonical-retest-m1.py*