#!/usr/bin/env python3
"""
M2f-Entry Canonical Retest — Post-M2d/e Baseline

Run 4 in the canonical retest series. Sets the M2f-entry baseline against
the v2 canonical query corpus, post-M2d MUX walk + M2e Integrations ship.
...
- Run 4 (May 8): TBD — M2f-entry baseline (this run)

Same methodology as Run 1-3. Dual scoring (routing + quality), LLM-as-judge,
honest-failure tagging. No methodology changes from Run 3.
...
Usage:
    ...
    POSTGRES_PORT=5433 ./venv/bin/python dev/2026/05/08/canonical-retest-m2f-baseline.py

Outputs:
    dev/2026/05/08/canonical-retest-m2f-baseline-results.csv
    dev/2026/05/08/canonical-retest-m2f-baseline-report.md
"""
...
SESSION_ID_PREFIX = "canonical-retest-m2f-baseline"
...
def main():
    ...
    # Write outputs
    csv_path = OUTPUT_DIR / "canonical-retest-m2f-baseline-results.csv"
    report_path = OUTPUT_DIR / "canonical-retest-m2f-baseline-report.md"
