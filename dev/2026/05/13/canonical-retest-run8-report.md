...
|---------|-------|------------|
| PASS (judge ≥7) | 43 | 68.3% |
| MARGINAL (judge 5-6) | 14 | 22.2% |
| FAIL (judge <5 or auto-fail) | 5 | 7.9% |
| Skipped (NOT_IMPL or ERROR) | 1 | 1.6% |

**Quality pass rate (judged queries)**: 43/62 (69.4%)
...
## Human Escalation Queue (10 items)
...
*Generated 2026-05-13 08:17 by canonical-retest-m1.py*
