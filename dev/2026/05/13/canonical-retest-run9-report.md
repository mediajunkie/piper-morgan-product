...
|---------|-------|------------|
| PASS (judge ≥7) | 44 | 69.8% |
| MARGINAL (judge 5-6) | 15 | 23.8% |
| FAIL (judge <5 or auto-fail) | 3 | 4.8% |
| Skipped (NOT_IMPL or ERROR) | 1 | 1.6% |

**Quality pass rate (judged queries)**: 44/62 (71.0%)
...
| Spatial | 4 | 4/4 | 4 | 0 | 0 |
| Capability | 5 | 3/5 | 3 | 1 | 0 |
| Predictive | 5 | 4/5 | 4 | 0 | 1 |
| Conversational | 5 | 5/5 | 4 | 1 | 0 |
| Scheduling | 5 | 5/5 | 3 | 2 | 0 |
| Documents | 4 | 3/4 | 2 | 2 | 0 |
...
- **Q27** (Conversational): `Tell me more about the GitHub integration` — auto-fail (2+ dimensions scored 0)
  - Judge: R=3 C=0 T=3 = 6/MARGINAL (conf 0.80)
- **Q37** (Documents): `Compare these two documents` — auto-fail (2+ dimensions scored 0)
  - Judge: R=3 C=0 T=2 = 5/MARGINAL (conf 0.80)
- **Q38** (Documents): `Synthesize these sources into a summary` — auto-fail (2+ dimensions scored 0)
  - Judge: R=3 C=0 T=2 = 5/MARGINAL (conf 0.80)
...
- **Q149** (Slack (multi-turn)): `/standup` — auto-fail (2+ dimensions scored 0)
...
- **Q31** (Scheduling, M2): `Schedule a meeting about the roadmap` — MARGINAL
...
*Generated 2026-05-13 18:54 by canonical-retest-m1.py*
