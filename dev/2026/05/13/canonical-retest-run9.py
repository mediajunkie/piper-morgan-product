#!/usr/bin/env python3
"""
Canonical Retest Run 9 — Multi-Turn Evaluation Harness (#1070)
...
- Run 9 (May 13): multi-turn harness, same M2f-end codebase
...
Usage:
    ...
    POSTGRES_PORT=5433 ./venv/bin/python dev/2026/05/13/canonical-retest-run9.py

Outputs:
    dev/2026/05/13/canonical-retest-run9-results.csv
    dev/2026/05/13/canonical-retest-run9-report.md
"""
...
SESSION_ID_PREFIX = "canonical-retest-run9"
...
# --- Canonical Queries v3 (61 single-turn + 3 multi-turn variants, Run 9) ---
...
"""
    ...
    # Write outputs
    csv_path = OUTPUT_DIR / "canonical-retest-run9-results.csv"
    report_path = OUTPUT_DIR / "canonical-retest-run9-report.md"
