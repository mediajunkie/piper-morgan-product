...
Usage:
    ...
    POSTGRES_PORT=5433 ./venv/bin/python dev/2026/05/09/canonical-retest-m2f-run7.py

Outputs:
    dev/2026/05/09/canonical-retest-run7-results.csv
    dev/2026/05/09/canonical-retest-run7-report.md

Changes from v1 (May 8 retest script):
- Phase 0 fixture reset before authentication (truncate canonical-test todo state)
- Auto-fail rule softened: 2-or-more dims=0 (was: any single dim=0)
- See `dev/2026/05/08/floor-fabrication-investigation.md` for rationale
"""
...
"""
    ...
    # Write outputs
    csv_path = OUTPUT_DIR / "canonical-retest-run7-results.csv"
    report_path = OUTPUT_DIR / "canonical-retest-run7-report.md"
