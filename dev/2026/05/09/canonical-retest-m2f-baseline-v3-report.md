...
|---------|-------|------------|
| PASS (judge ≥7) | 39 | 63.9% |
| MARGINAL (judge 5-6) | 13 | 21.3% |
| FAIL (judge <5 or auto-fail) | 8 | 13.1% |
| Skipped (NOT_IMPL or ERROR) | 1 | 1.6% |

**Quality pass rate (judged queries)**: 39/60 (65.0%)
...
## Human Escalation Queue (14 items)
...
- **Q8** (Temporal): `What's on the agenda for today?` — auto-fail (2+ dimensions scored 0)
  - Judge: R=2 C=0 T=1 = 3/FAIL (conf 0.90)
...
*Generated 2026-05-09 06:53 by canonical-retest-m1.py*
