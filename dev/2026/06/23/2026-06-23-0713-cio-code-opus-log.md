...
- Moved Exec scope-confirm + the (addressed) Ship-048 nudge to read/. **Inbox empty → (0,0).** Cron armed; next 13:07. Open loops: Lead's review of the skill rewrite (→ then DinP); Docs's read on the worktree fold.