...
| # | Item | Filed | Notes |
|---|---|---|---|
| 1 | **BYOC — active focus. Phase A first pass run; Phase B recommendation sent, awaiting PM's decision** | 2026-07-26, converged 08-18, restarted 09-22 | **Current PM-attention state lives in `pa-carry-forward.md`, not here.** **Phase B, 09-22**: PM asked for an actual proposal, not just the gap. Researched this week's real Fly/DNS mechanics before recommending (grant-gated Fly access, PM-owned DNS by standing 07-10 rule, Pard sole hands-on executor this week with fresh context) — recommended reusing that exact pattern (PM-granted scoped Fly access to Pard) over PM's floated Arch-supervising-a-fresh-prog-instance idea, with reasons given. Sent, not yet answered: `mailboxes/pa/sent/proposal-pa-to-exec-cc-pm-mcp-dns-tls-assignment-recommendation-2026-09-22.md`. **Phase A**: naming-test designed and run 09-22 (`dev/active/byoc-tool-catalog-naming-test-design-2026-09-22.md`, `dev/active/probes/RESULTS-naming-test-first-pass-2026-09-22.md`). Cost-narrowed first pass (Claude only, n=1/cell, 24 calls not 96): situation-shaped 12/12, object-shaped 10/12 — opposite PPM's stated worry, but a real same-author disambiguation-quality confound named honestly rather than overclaimed. Honest next step named (independent-author control), not executed — awaiting a call on whether it's worth the further spend. Full plan: `dev/active/byoc-parallel-work-plan-2026-09-15.md`; readiness checklist: `dev/active/byoc-hosted-alpha-readiness-checklist-2026-09-15.md`. |
