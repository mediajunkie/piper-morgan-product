...
| # | Item | Filed | Notes |
|---|---|---|---|
| 1 | **BYOC — active focus. Phase A THREE PASSES run; Phase B APPROVED by PM 09-23, execution notice delivered directly to Pard** | 2026-07-26, converged 08-18, restarted 09-22 | **Phase B, APPROVED 09-23**: PM approved the recommendation directly in conversation (reuse the PM-granted-Pard-Fly-access pattern). Notice first sent to Exec for relay, then **PM instructed direct delivery** — re-sent straight into Pard's real inbox (`mediajunkie` commit `26f4c03`, pushed) — nothing further needed from PA; watch for Pard/PM to actually execute. **Phase A, pass 3 (targeted follow-up, PM-approved "Please proceed!" 09-23)**: varied the utterance for the one persisting failure — 2 unambiguous phrasings resolved correctly under BOTH naming schemes, the one genuinely ambiguous phrasing failed under object-shaped a THIRD time (new utterance) while situation-shaped succeeded again. **Sharper finding now**: situation-framing gives a real, replicated disambiguation benefit specifically for ambiguous user phrasing, not a general naming advantage — unambiguous phrasing shows no difference either way. Full writeup: `dev/active/probes/RESULTS-naming-test-followup-2026-09-23.md`. Passes 1-2: `dev/active/probes/RESULTS-naming-test-first-pass-2026-09-22.md`, `dev/active/probes/RESULTS-naming-test-control-2026-09-22.md`. Full plan: `dev/active/byoc-parallel-work-plan-2026-09-15.md`; readiness checklist: `dev/active/byoc-hosted-alpha-readiness-checklist-2026-09-15.md`. |
