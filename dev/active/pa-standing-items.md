...
| # | Item | Filed | Notes |
|---|---|---|---|
| 1 | **BYOC — RESTARTED 09-22 as PA's active focus, per PM's direct instruction** | 2026-07-26, converged 08-18, restarted 09-22 | **Current PM-attention state lives in `pa-carry-forward.md`, not here** — Phase B ownership (who stands up `mcp.pipermorgan.ai`) is the one real batched item, flagged to Exec's rollup 09-22. **Phase A progress, this row**: tool-catalog naming-test design done (`dev/active/byoc-tool-catalog-naming-test-design-2026-09-22.md`) — grounded in a real catalog inventory (53 operations, 100% object-shaped today, zero situation-shaped names exist), 12-operation test sample, method designed against PPM's actual PDR-006 question. **Not yet done**: running the probe (live API, both vendors) — next concrete step. Full plan: `dev/active/byoc-parallel-work-plan-2026-09-15.md`; readiness checklist: `dev/active/byoc-hosted-alpha-readiness-checklist-2026-09-15.md`. |
