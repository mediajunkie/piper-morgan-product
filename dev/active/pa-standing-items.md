...
| 2 | **T-own-surface — FOUR pre-registered rounds run 09-24/25, series likely closed per CXO** (GitHub: #1468, Production, open) | 2026-09-20 | PM "spend the tokens"; PPM split ruling 07:24. Four rounds, each isolating one variable, each delivered within the hour of registration: R1 metadata form 0/2 both vendors; R2 member+counted Claude 2/2 GPT-4o 0/2; R3 member+uncounted Claude 2/2 GPT-4o 0/2; R4 member+sibling-shaped Claude 1/2 GPT-4o 0/2. **Cumulative: GPT-4o 0/8 across every design tried (form/count/shape all isolated, none explains it); Claude 5/6 across all member-form rounds, 0/2 on metadata** — form is the variable that mattered, only on Claude. CXO named round 4 likely-last regardless of result; cumulative table delivered. T-MCP-surface `UNMEASURED` throughout all four. Results: `dev/active/probes/RESULTS-t-own-surface-preregistered-2026-09-24.md`, `-h1-mitigation-2026-09-24.md`, `-h1-round3-2026-09-24.md`, `-h1-round4-2026-09-24.md`. **Waiting on**: CXO's rubric write-up, if any. Not PM-gated. |
