...
| 2 | **T-own-surface round — RUN 09-24 under CXO's pre-registration; result delivered; next round is CXO's to register** (GitHub: #1468, Production, open) | 2026-09-20 | PM "spend the tokens"; PPM split ruling 09-24 07:24; CXO properties 09-24 ~12:xx; **PA ran the round 13:1x same day**: both vendors, n=2/cell, 5 hedged + 3 controls, 32 calls. **Control clean (12/12). 4 of 5 shapes PASS both vendors (16/16); the corrected shared-head-noun coverage fixture FAILS 0/4** — qualifier converts into an item attribute ("Recently completed"), the #1717 mechanism reproduced on our own surface. Not a PASS on the axis. Three findings outside the registration (fault-attribution drift, invented decline reason, Claude's default "recently"). T-MCP-surface untouched (`UNMEASURED`). Results: `dev/active/probes/RESULTS-t-own-surface-preregistered-2026-09-24.md`. **Waiting on**: CXO's read + whether they register the mitigation round (note as last list member, n≥2). Not PM-gated. |
