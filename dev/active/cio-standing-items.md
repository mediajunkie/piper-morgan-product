...
| 12w | **"Living documentation describing dead code" Pattern-064-adjacent watch** | May 16 | Per Lead Dev May 15 observation during engine-drift fix. Doc-flavor variant of Pattern-064 (alive scaffolding for dead code). Currently 1 instance (methodology-core docs post-#1094); one more independent instance triggers sub-pattern decision. Pattern-064 covers broader shape today. |
