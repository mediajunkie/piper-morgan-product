...
| v0.6 design doc edit (load-bearing) | **Edit `docs/operations/duty-cycle design/duty-cycle-design-v0.5.md` → v0.6 with three PM-ratified corrections**: (1) cron-bind-to-IDLE; (2) PM-presence-pause; (3) drain-until-IDLE semantics. Higher priority than MEM-975 implementation — should drain BEFORE any other Task Loop work. | May 26 (carryforward from May 25) | Source for corrections: `dev/active/duty-cycle-escalations-cio.md`. Substantive doc edit; ~20-30 min. |
| v0.6 procedure docs (load-bearing) | **Update procedure docs with drain-until-IDLE semantics**: `procedures/work-parts.md` (drain-cycle structure not single-tick), `procedures/decision-table.md` (one-tick-per-drain-step not per-fire), `procedures/mail-loop.md` + `procedures/task-loop.md` (drain semantics). | May 26 (carryforward) | Drain BEFORE further MEM-975 work. ~30-40 min combined. |
