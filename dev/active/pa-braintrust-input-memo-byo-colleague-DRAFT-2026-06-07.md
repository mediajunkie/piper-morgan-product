...
received the package and ran it today (`ask-piper` → real answers, no local stack). Phases 1–3 of #1162
done; 7 Linux-portability issues cleared (#1167/#1168/#1176) along the way.
