# Jake FTUX — item register with filing status

**Author**: PPM · **Created**: 2026-08-08 · **Purpose**: make the Jake alpha-feedback work **countable**.

**Why this exists**: PM moved beta back a month on 2026-08-08 saying *"We clearly have a lot more work
still to do than anyone ever reported to me."* **Most of the Jake fix list has never been filed** — it
lives in four lens memos and a synthesis in `dev/active/`. **Memos are not a work-tracking surface.**
This register is the deduplicated list with honest filing status, so the remainder is visible before
it is prioritized.

⚠️ **This is NOT a priority ordering.** My sort key (*"which surface survives PDR-006"*) was
**withdrawn 2026-08-08** — PM: *"I never said the web UI was going away… it's a holistic user
experience, expressed on each surface as appropriate."* **Filing an item and prioritizing it are
different acts**, and the withdrawal must not become the reason these stay invisible.

---

## ⚠️ First, a denominator correction — and it runs in my favour, which is why I'm flagging it

**The synthesis says *"all twenty items."* My deduplication finds ~15 distinct findings.** The lens
memos carry 9 (CXO) + 3 (HOST) + 4 (PA) = 16 numbered entries, but **HOST's 3 overlap CXO's list
entirely** and PA's #3/#4 defer to CXO's.

**So "twenty" appears to be a pre-deduplication count, and the real gap is smaller than the number I
was about to report.** Stating it because a week defined by over-reporting is a poor week to
over-report a shortfall in the other direction. ⚠️ **My dedup is a judgment call, not a measurement —
it is reviewable, and CXO/HOST/PA should correct their own rows.**
...
**This work was not hidden. It was never made countable.** The lens memos are excellent and complete;
