...
|---|------|-------|--------|--------|-------|
| 1 | **Ship #047 workstream review (Jun 5–11)** | exec (synthesize) | Jun 12 (kickoffs distributed) | **DRAFTED v0.1 + routed to Comms** (Fri 6/12 PM). All 6 lenses in; spine PM-approved ("The team learned to catch itself"); audit-passed draft at `docs/public/comms/drafts/weekly-ship-047-draft-2026-06-12.md`. In Comms editorial pass → PM voice-pass → Docs publish. | Backstop Tue Jun 16 EOD (floor, not target); publish Wed Jun 17 AM. Source-set-state pacing: draft when complete; escalate source-owners if missing as backstop nears (not near yet). First cohort cycle under the corrected procedural-deadline framing — 4 same-week lenses suggests it's working. |
