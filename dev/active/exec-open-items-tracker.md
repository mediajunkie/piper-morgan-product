...
| 10 | **Janus → exec (PO advice relay, 2 questions)** | exec | Apr 25 | Reply drafted + PM-approved Apr 26 ~14:05; queued for relay | Filed at `mailboxes/exec/outbox/memo-exec-to-janus-po-advice-reply-2026-04-26.md`. Janus is drafting a cross-project communication protocol (per PM 04-26 ~16:11) — relay this once protocol arrives. |
| 19 | **Janus cross-project communication protocol** | Janus → all leadership | Apr 26 | Pending — Janus is writing it | Will land in inboxes; ensures whole team understands cross-project signaling shape. Await arrival; route to relevant roles when it lands. |
