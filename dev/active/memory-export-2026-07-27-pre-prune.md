# Memory pool — VERBATIM EXPORT (pre-prune snapshot)

**Taken 2026-07-27 by HOST, before any merge/prune of the shared pool.**

⚠️ Memory files live in `~/.claude-pm/` and are **NOT under version control** — deletion is
irreversible (no revert, no reflog). This git-tracked export is the ONLY rollback path for the
prune that follows. Restore by writing any block below back to its filename in the memory dir.

**171 files** (includes MEMORY.md).
...
**170 memories on disk.** Generated from the actual directory listing, never from a prior index.
...
**The line limit cannot be fixed by shortening text.** One entry = one line, so with 170 memories on disk the floor is 170 lines before any header — the real options are prune/merge, per-type index files with a router, or a denser entry format (cheapest, and worst for recall, since the description is what makes an index useful). **That is a governance decision about the whole cohort's shared pool, not a formatting choice for whoever trips the limit.** ⚠️ **Memory files are NOT under version control — deletion is irreversible. Export to a git-tracked file BEFORE pruning anything.**
...
## Feedback — how this cohort works, and the corrections behind it (128)
...
- feedback_deadlines_are_triage_tools_not_default_pacing — PM's directive that work that can be done now should be…
- feedback_deadlines_as_latest_acceptable_not_scheduled_windows — When asking an agent (or the cohort) to do work, never…
- feedback_deadlines_last_possible_time — A deadline is the latest a thing can be done, not the…
...
- feedback_addressing_hold_pattern_is_wrong_move_to_read_immediately — PM correction 2026-05-15 ~11:29: "Why are the workstream…
- feedback_chief_reads_logs_not_staff_reports — PM correction 2026-05-20 (after the Ship #043 fab-catch…
- feedback_drop_day_n_framing_in_chat — PM directive 2026-05-24: *"The whole 'Day x'…
- feedback_drop_day_x_nomenclature_from_pm_surfaces — PM May 24: *"The whole 'Day x' nomenclature is not very…
- feedback_exec_nickname_is_exec_or_the_chief_not_cos — PM directive 2026-05-15: "as my chief of staff and…
- feedback_fold_is_crutch_word — PM (xian) 2026-06-27: "fold is becoming a claude word…
- feedback_idle_means_do_low_priority_not_nothing — Source: PM directive 2026-05-27 ~5:51 PM PDT during…
- feedback_log_update_rides_with_the_commit — PM 2026-05-29: *"Why aren't you keeping your log up to…
- feedback_pre_authorized_for_unblocked_work_just_do — Source: PM directive 2026-05-27 6:25 PM PDT during Day-1…
- feedback_role_official_name_in_parens_especially_pa_vs_ppm — PM May 27: *"When we refer to roles we should still give…
- feedback_ship_drafting_canonical_artifacts_first — PM correction 2026-05-19: Ship #043 v0.1 was drafted…
- feedback_sprint_membership_is_project_board_not_labels — Source: PM clarification 2026-05-27 ~7:15 PM PDT during…
- feedback_three_registers_dont_assume_reader_context — PM directive, 2026-06-05 (from the skunkworks BYOC…
- feedback_time_lord_doctrine_no_false_urgency — PM May 24: *"Please remove any references to time or…
- feedback_ui_fix_requires_template_render_test_not_curl_200 — Source: Lead Dev self-correction 2026-05-30, after two…
- feedback_verify_show_stat_post_commit_pre_push — Established 2026-05-15 after PPM commit `a40c1f11`…
- feedback_wait_for_publish_handoff — When PM names a blog publish as a priority for the day…
- feedback_weekends_are_piper_morgan_prime_time — PM, 2026-06-06. Piper Morgan is xian's side project —…
- feedback_worktree_default_for_substantive_work — Established 2026-05-15 by PM after PPM May 15 morning…
````
...
## `feedback_deadlines_as_latest_acceptable_not_scheduled_windows.md`
...
## `feedback_drop_day_x_nomenclature_from_pm_surfaces.md`
