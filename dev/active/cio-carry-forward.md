...
**Cron**: `bca62d0d` · `7 10,16,22` LEAN · rotated (delete-then-create) 2026-08-31 22:37 from
`a9ed03f9` · verified via `CronList` — exactly one job survived · **auto-expires ~2026-09-07 22:37**.
