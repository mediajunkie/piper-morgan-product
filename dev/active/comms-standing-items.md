...
|---|---|---|---|
| ***The Solo Founder Paradox* (Jun 14 insight)** | Docs proofread requested 6/14 (`ec3ee00ca`). Draft clean: PM voice-pass done, all markers filled, image frontmatter added (ai-court.png). After Docs: PM final voice-pass → publish. | Docs (proofread) → PM (voice-pass) | Calendar: Jun 14 pub. Already past pubDate but no URL yet — Docs knows urgency. |
