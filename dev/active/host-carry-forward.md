...
- **Values/ethics document** (`docs/legal/values-DRAFT.md`) — ✅ **Effectively done, one loose end not HOST's.** All four decisions ratified 08-15; Comms converted voice to third-person same night (`0676b7b37`), HOST did the offered substance-accuracy second pass 08-16, independently re-grepped for I/we/us/our — clean, both edits scope-neutral (one arguably sharper than the original). **One outstanding item before DRAFT status lifts**: the README link (decision 1) doesn't exist yet — Comms found and flagged it, not clearly either of our lane to add. Watch for whoever picks it up; nothing further owed by HOST.
