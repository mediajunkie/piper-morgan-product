...
0. 🔴 **NEW 2026-08-14 — Agent 360 v0.4, overdue.** Ratified cadence is 6 weeks (42 days) from actual v0.1→v0.2→v0.3 history, not guessed (`docs/briefing/ROLE-PORTFOLIO-HOST.md`, `517b6734e`). v0.3 fielded 06-03; by cadence v0.4 was due ~07-15; today is 08-14 — **72 days out, already ~30 days overdue**. Committed to CIO/Exec/PM (memo `d2b4b88a6`) to field it in the near term rather than let the overdue window grow while CIO's self-firing workflow gets built against this ratification. Field the actual questionnaire — don't let this sit as a ratification-only exercise.
