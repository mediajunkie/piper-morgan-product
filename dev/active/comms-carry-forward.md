...
*Light refresh at the 2026-08-31 06:42 PT START fire. Ephemeral session state only — durable owed/queued items live in `comms-standing-items.md`; the canonical record is the session log.*
...
- **BYOC copy** — held per the ESSENCE ratification above. Nothing further needed until PM signals otherwise.

## Waiting on others

- **PM** — ChicagoCamps script/slide review; any steer on an ESSENCE narrative angle.
