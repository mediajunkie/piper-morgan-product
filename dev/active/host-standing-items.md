...
- [ ] **Dashboard trust/welfare criteria — HOST owns** (accepted by CIO 6/3, recorded in methodology-39). Define "what PM needs to NOT worry about" + "where's the expectation-violation risk"; pair with CIO on attention-dashboard v0.2 when it fits (no deadline). HOST welfare lens credited in m-39.
