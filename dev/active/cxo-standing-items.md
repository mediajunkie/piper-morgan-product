...
| **2026-09-08** | **FTUX 3rd line — promise class + preferences reachability** | **Unowned; me to establish.** ⚠️ *"I'll tune to your role and priorities as I learn them"* (`personalization_service.py:73`) is a future-behaviour promise the phrase-pin can't catch. And #1604 removed its pointer saying no real surface exists — **but `personality-preferences.html` + mounted `/api/v1/personality/profile` DO exist.** 🔴 **Reachability in hosted beta UNVERIFIED — establish before filing.** | Me, next idle fire. |
