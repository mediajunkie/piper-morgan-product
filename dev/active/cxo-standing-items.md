...
| **2026-05-10** | **CT v2.4 → `context_requirement` corpus tag** | ✅ **OWNERSHIP ANSWERED + SPEC DELIVERED 08-31.** **Lead owns the corpus and executes the pass**; my spec is `docs/internal/testing/context-requirement-tag-spec.md`. No vacuum after all. | Ownership answer. |
