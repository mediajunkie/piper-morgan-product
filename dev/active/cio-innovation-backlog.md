...
| 44 | ~~"Silent State Mutation in Shared Working Tree" — parent meta-pattern~~ — **PROMOTED to Emerging May 11** as Pattern-067 (see Emerging tier #46) | Code agent May 10; HOST May 10; PM May 11 directive | Pattern-067 filing per PM May 11 ("we need to solve these issues to avoid a real problem occurring or loss of valuable effort") | **Promoted** to Emerging tier. Was Operational #44; now Pattern-067 in catalog. |
| 45 | ~~"Coarse Triggers Causing False-Positive Triage Cost" — hook-design meta-pattern~~ — **PROMOTED to Emerging May 11** as Pattern-068 (see Emerging tier #47) | Code agent May 10; HOST May 10; PM May 11 directive | Pattern-068 filing per PM May 11 ("close the loop") — elevated from tactical-observation hold to formal Emerging | **Promoted** to Emerging tier. Was Operational #45; now Pattern-068 in catalog. |
...
| 46 | **Pattern-067 (Silent State Mutation in Shared Working Tree)** | Filed Emerging May 11 by CIO with PM ratification | Promotion to Proven contingent on naming holding through ~2 more sub-instance recurrences across named children, OR a single new-shape child instance fitting the parent. Parent subsumes anti-pattern P-13 (branch-drift) + P-15 (branch-collision) + P-16 (residue-accumulation) + P-17 (path-fragmentation, new same session). |
| 47 | **Pattern-068 (Coarse Triggers Causing False-Positive Triage Cost)** | Filed Emerging May 11 by CIO with PM directive ("close the loop") | Promotion to Proven contingent on cross-mechanism recurrence within two weeks — a different hook/gate/validator producing the same shape. PreCompact-hook-only recurrence does not promote (evidence about the one hook, not the pattern class). |
