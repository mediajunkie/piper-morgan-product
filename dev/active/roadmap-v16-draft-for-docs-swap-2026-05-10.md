...
**Status**: DRAFT — for Docs swap into `docs/internal/planning/roadmap/roadmap.md`. Pending CEO ratification.
**Supersedes**: v15.0 (April 11, 2026) — to be archived at `docs/internal/planning/historical/roadmap-v15.0-2026-04-11.md` (per v14.3 archive precedent)
