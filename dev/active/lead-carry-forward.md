...
## Owed next fire (named)
- **Agent 360 v0.4 answers** → memo to host inbox (HOST fielded 08-14; fresh-session trigger named).
- Phase 1b review-and-merge on the enrichment agent's report (delta attributable to the ratified set).
