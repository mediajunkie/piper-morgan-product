...
- **Alpha = Fly v137 (`fd535398c9`, 09-25 16:3x)** — everything on main deployed; inversion flag UNCHANGED (3 read waves + create_todo) — wave 2/3 + create_reminder flips wait on the shadow score: v0.8.14.0 + every
