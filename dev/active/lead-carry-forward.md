...
## ▶ NEXT — Lead queue
**Unblocked unilateral Lead-code is DRAINED.** Remainder is PM/Arch/CXO/product-gated:
...
- **#1312 (DB↔model drift, ~111 diffs)** — Arch-eye (multi-Base `personality`; schema-risky). NOT solo-Lead. Diagnosed in the issue.
