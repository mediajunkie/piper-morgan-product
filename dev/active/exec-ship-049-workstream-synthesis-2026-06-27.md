...
1. **🔑 ADR-071 timeline (Arch) — unblocks TWO lanes at once.** It's PPM's #1 ask and the critical path for #1237 (entity-model / 4-type Radar); CXO's nav lane is parked on the same dependency. The first Arch move here frees both. *PPM: "if ADR-071 has a timeline, PPM should know it."*
