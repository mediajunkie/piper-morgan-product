...
*DRAFT v0.6 | PPM | 2026-06-03 — EC-2 platform-affordance-bounded qualifier folded (flag-back resolved; Arch+CXO qualifier-needed, CXO confirmed) + paired AC-1 surface-presence detection + Q7 note. Remaining v1.0 gates: Comms external-language frame + PM ratification (Lead Dev integration read = non-gating example-refinement). Not canonical until PM ratification.*
